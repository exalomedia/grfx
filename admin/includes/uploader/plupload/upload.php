...
/* 
// Support CORS
header("Accegrfx-Control-Allow-Origin: *");
...
$uploadDest = "../../../../../../uploads/grfx_uploads/protected";

if(is_dir($uploadDest)){
    $targetDir = "../../../../../../uploads/grfx_uploads/protected";
} else {
    die();
}
